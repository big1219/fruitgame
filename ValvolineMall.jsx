...
const PRODUCTS = [
  ...
  { id: 43, cat: 'passenger', badge: null, name: '발보린 Turbo GX7, 5W30', spec: '4L × 4개 (1박스)', consumer: 170000, biz: 110000, tag: 'API SQ / ILSAC GF-7 · GDI/T-GDI', emoji: '🛢️', img: '/products/turbo-gx7-5w30-4l.webp' },
  { id: 44, cat: 'passenger', badge: null, name: '발보린 Turbo GX7, 10W40', spec: '4L × 4개 (1박스)', consumer: 162000, biz: 103000, tag: 'API SQ · GDI/T-GDI/LPG', emoji: '🛢️', img: '/products/turbo-gx7-10w40-4l.webp' },
  { id: 45, cat: 'passenger', badge: null, name: '발보린 Turbo GX10, 5W40', spec: '1L × 12개 (1박스)', consumer: 176000, biz: 114000, tag: 'API SQ · GDI/T-GDI', emoji: '🛢️', img: '/products/turbo-gx10-5w40-1l.webp' },
  ...
  { id: 36, cat: 'passenger', badge: '특가', name: '발보린 Turbo FX, 0W30', spec: '6L × 3개 (1박스)', consumer: 196000, biz: 126000, tag: 'ACEA C2 · 6L', emoji: '🛢️', img: '/products/turbo-fx-0w30-6l.webp' },
  ...
  { id: 14, cat: 'transmission', badge: 'BEST', name: '발보린 ATF MULTI HK', spec: '20L 말통', consumer: 132000, biz: 84000, tag: '현대/기아 4~8단 합성미션오일', emoji: '⚙️', img: '/products/atf-multi-hk-20l.webp' },
  { id: 15, cat: 'transmission', badge: null, name: '발보린 ATF MLV Plus', spec: '1L × 12개 (1박스)', consumer: 138000, biz: 88000, tag: '현대/기아 SP-IV · 6단/8단 AT', emoji: '⚙️', img: '/products/atf-mlv-plus-1l.webp' },
  { id: 46, cat: 'transmission', badge: null, name: '발보린 ATF Multi SYN', spec: '18L 말통', consumer: 168000, biz: 106000, tag: 'ZF 8HP/6HP · 100% 합성 ATF', emoji: '⚙️', img: '/products/atf-multi-syn-18l.webp' },
  { id: 17, cat: 'transmission', badge: null, name: '발보린 CVT+', spec: '1L × 12개 (1박스)', consumer: 142000, biz: 92000, tag: '닛산/토요타/혼다 CVT 규격', emoji: '⚙️', img: '/products/cvt-plus-1l.webp' },
  { id: 47, cat: 'transmission', badge: null, name: '발보린 CVT+', spec: '18L 말통', consumer: 158000, biz: 98000, tag: '100% 합성 CVT · 롱라이프', emoji: '⚙️', img: '/products/cvt-plus-18l.webp' },
  { id: 48, cat: 'transmission', badge: '특가', name: '발보린 ATF MLV Plus', spec: '20L 말통', consumer: 172000, biz: 108000, tag: '현대/기아 ~8단, ZF ~9단', emoji: '⚙️', img: '/products/atf-mlv-plus-20l.webp' },
  { id: 49, cat: 'transmission', badge: null, name: '발보린 DCTF', spec: '1L × 12개 (1박스)', consumer: 146000, biz: 94000, tag: 'DCT/DSG 전용 · 100% 합성', emoji: '⚙️', img: '/products/dctf-1l.webp' },
  { id: 18, cat: 'transmission', badge: null, name: '발보린 Turbo Gear 5, 80W90 GL-5', spec: '20L 말통', consumer: 126000, biz: 79000, tag: 'API GL-5, MIL-L-2105D · 기어유', emoji: '⚙️', img: '/products/turbo-gear5-80w90-20l.webp' },
  { id: 54, cat: 'transmission', badge: null, name: '발보린 Turbo Gear FD, 75W85 GL-4', spec: '20L 말통', consumer: 132000, biz: 83000, tag: '수동변속기 전용 기어유', emoji: '⚙️', img: '/products/turbo-gear-fd-75w85-20l.webp' },
  { id: 50, cat: 'transmission', badge: null, name: 'DURAMAX Top Truck Gear 4, 80W GL-4', spec: '20L 말통', consumer: 148000, biz: 92000, tag: 'MAN 341, ZF TE-ML 02B/17A', emoji: '⚙️', img: '/products/top-truck-gear4-80w-20l.webp' },
  { id: 51, cat: 'transmission', badge: null, name: 'DURAMAX Top Truck Gear 5, 80W90 GL-5', spec: '20L 말통', consumer: 152000, biz: 95000, tag: 'Scania/MAN/ZF · 대형차 기어유', emoji: '⚙️', img: '/products/top-truck-gear5-80w90-20l.webp' },
  { id: 52, cat: 'transmission', badge: null, name: '발보린 ECO GEAR, 75W80', spec: '18L 말통', consumer: 146000, biz: 91000, tag: '리타더 전용 · 수입 대형차', emoji: '⚙️', img: '/products/eco-gear-75w80-18l.webp' },
  { id: 59, cat: 'coolant', badge: null, name: '발보린 Anti-Freeze Coolant', spec: '3L × 6개 (1박스)', consumer: 84000, biz: 52000, tag: '알루미늄 보호 · 무붕산/무질산', emoji: '🧊', img: '/products/antifreeze-coolant-3l.webp' },
  { id: 20, cat: 'moto', badge: 'BEST', name: 'Duramoto 4T 7, 10W40', spec: '1L × 12개 (1박스)', consumer: 118000, biz: 72000, tag: '100% 합성 · 이륜차 4행정', emoji: '🏍️', img: '/products/duramoto-4t7-10w40-1l.webp' },
  { id: 57, cat: 'moto', badge: null, name: 'Duramoto 4T 10, 10W40', spec: '1L × 12개 (1박스)', consumer: 126000, biz: 78000, tag: 'PAO Core · 100% 합성', emoji: '🏍️', img: '/products/duramoto-4t10-10w40-1l.webp' },
  { id: 58, cat: 'moto', badge: null, name: 'Duramoto PAO, 10W50', spec: '1L × 12개 (1박스)', consumer: 138000, biz: 86000, tag: '100% PAO 합성 · 최고성능', emoji: '🏍️', img: '/products/duramoto-pao-10w50-1l.webp' },
  { id: 21, cat: 'moto', badge: null, name: 'Duramoto 4T 5, 10W40', spec: '1L × 12개 (1박스)', consumer: 108000, biz: 64000, tag: '이륜차 4행정 · 반합성', emoji: '🏍️', img: '/products/duramoto-4t5-10w40-1l.webp' },
  { id: 55, cat: 'moto', badge: '특가', name: 'Duramoto 4T 5, 10W40', spec: '20L 말통', consumer: 128000, biz: 78000, tag: 'API SG/CD · 이륜차 4행정', emoji: '🏍️', img: '/products/duramoto-4t5-10w40-20l.webp' },
  { id: 56, cat: 'moto', badge: null, name: 'Duramoto 2T', spec: '1L × 12개 (1박스)', consumer: 96000, biz: 58000, tag: '2행정 전용 · 반합성', emoji: '🛵', img: '/products/duramoto-2t-1l.webp' },
  { id: 22, cat: 'moto', badge: null, name: 'Duramoto Scooter, 5W40', spec: '1L × 12개 (1박스)', consumer: 112000, biz: 68000, tag: 'PAO Core · 스쿠터 전용', emoji: '🛵', img: '/products/duramoto-scooter-5w40-1l.webp' },
  { id: 24, cat: 'industrial', badge: null, name: '발보린 Turbo Hydraulic Fluid AW-CZ, ISO VG 46', spec: '20L 말통', consumer: 88000, biz: 52000, tag: '건설 중장비/산업용 유압작동유', emoji: '🏗️', img: '/products/turbo-hydraulic-aw-cz-vg46-20l.webp' },
  { id: 53, cat: 'industrial', badge: null, name: '발보린 Farmplus Hydra Trans', spec: '20L 말통', consumer: 102000, biz: 62000, tag: '트랙터 유압/미션 겸용', emoji: '🚜', img: '/products/farmplus-hydra-trans-20l.webp' },
  { id: 25, cat: 'carcare', badge: null, name: '발보린 Engine Flush', spec: '1L × 12개 (1박스)', consumer: 108000, biz: 66000, tag: '프리미엄 엔진 세정제', emoji: '🧪', img: '/products/engine-flush-1l.webp' },
  { id: 26, cat: 'carcare', badge: null, name: '발보린 MAX Grease', spec: '15kg 통', consumer: 140000, biz: 88000, tag: '차량/산업용 범용 그리스', emoji: '🧪', img: '/products/max-grease-pail.webp' },
  { id: 60, cat: 'carcare', badge: null, name: 'Tectyl ML-100 방청제', spec: '520ml × 12개 (1박스)', consumer: 132000, biz: 82000, tag: '차체 내부 방청 스프레이', emoji: '🧪', img: '/products/tectyl-ml100-520ml.webp' },
  { id: 61, cat: 'carcare', badge: null, name: 'Tectyl TM-100 Black Safe', spec: '600ml × 12개 (1박스)', consumer: 138000, biz: 86000, tag: '하부/섀시 방청 스프레이', emoji: '🧪', img: '/products/tectyl-tm100-600ml.webp' },
]
...
const HERO_SLIDES = [
  ...
  },
  {
    ...
    kicker: '드럼/말통 대량구매관',
    title: '많이 쓰는 오일,\n드럼 단위로 더 저렴하게',
    desc: '20L 말통 · 드럼 단위 대량 발주 시 맞춤 견적 상담 지원',
    cta: '대량구매 견적 문의',
  },
  {
